...
class ForecastDataset(Dataset):
    ...
    def __init__(
        self, df, horizon=pd.Timedelta("1S"), interval=pd.Timedelta("1S"), sequence_length=5,
    ):
...
class LSTM(nn.Module, ForecastModel):
    ...
    def __init__(
        ...
        self._lstm = nn.LSTM(input_size=input_size, hidden_size=hidden_layer_size, num_layers=num_hidden_layers,)
